...
def readArgs ():
    ...
    parser.add_argument ("--examples-file", type=str, required=True, help="example file")
    parser.add_argument ("--predictions-file", type=str, required=True, help="Path to the output file")
...
def main (args):
    ...
    book_df = pd.read_csv (args.examples_file, sep="\t")
